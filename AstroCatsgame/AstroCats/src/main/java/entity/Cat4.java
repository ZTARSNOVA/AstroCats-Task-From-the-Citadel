...
public class Cat4 {
    ...
    public Cat4(AstroCats gp, int posX, int posY) {
        this.x = posX;
        this.y = posY;
        loadImage(gp);
    }
    ...
    public void loadImage(AstroCats gp) {
        try {
            image = ImageIO.read(getClass().getResource("/images/Cat4.png"));
            System.out.println("Cat4 image loaded");
        } catch (IOException e) {
            System.err.println("Error loading Cat4 image");
            e.printStackTrace();
        }
    }
